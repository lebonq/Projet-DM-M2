...
const std::vector<std::string> DM_PROJECT_TEX = {"assets/textures/static_object/wall.png" /*Wall Texture in 0*/
                                                 ...
                                                 ,
                                                 "assets/textures/static_object/water.png", "assets/textures/money/Gold-coin.png", "assets/textures/shadow.png", "assets/textures/monster/skeleton.png", "assets/textures/static_object/door.png", "assets/textures/static_object/floor_hole.png", "assets/textures/ladder.png" /*8*/
                                                 ,
                                                 "assets/textures/money/Gold-ingot.png", "assets/textures/heal/Apple.png", "assets/textures/heal/Beer.png", "assets/textures/heal/Ham.png", "assets/textures/heal/Meat.png", "assets/textures/defense/Helm.png", "assets/textures/defense/Iron-armor.png", "assets/textures/attack/Golden-sword.png", "assets/textures/attack/Wooden-sword.png" /*17*/
                                                 ,
                                                 "assets/textures/monster/goblin.png", "assets/textures/monster/mushroom.png"};
